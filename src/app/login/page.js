  ...
  return (
    <>
      <div className="flex h-screen gap-2">
        ...
        <div className="flex h-[96%] flex-[1] flex-col items-start justify-start rounded-[36px] bg-white overflow-hidden">
          ...
          <div className="mx-auto mt-20 w-10/12 flex-grow sm:mt-10  ">
            <h2 className="text-start font-lufga text-4xl sm:text-2xl">
