function Capsule({ children, icon = null, className = "", status = "none", onClick, style }) {
  const statusClasses = {
    none: " ",
  ...
  const iconClasses =
    "inline-flex items-center justify-center gap-2 !py-1 pl-1 pr-4 font-satoshi !font-bold hover:text-primary text-primary-tint-30";
