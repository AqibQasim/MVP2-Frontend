  ...
  return (
    <div className="flex h-[85vh] w-[100%] flex-col items-center justify-around font-lufga">
      <div className="flex flex-col items-center">
        <Image className="mb-[1rem]" src={imgSrc} width={100} height={100} alt="Success" />
        ...
        {onBoarding && containsOtp ? (
          <OnBoardingButton onClick={handleOpenOverlay2} >{buttonText}</OnBoardingButton>
        ) : (
      ...
      {!onBoarding && (
        <div className="mt-[3rem] flex w-auto justify-center rounded-full border-[1px] border-primary bg-primary-tint-90 px-[0.2rem] py-[0.3rem]">
          <span className="font-lufga text-[0.6rem] text-primary">
            <span className="font-semibold">Note:</span> Do not refresh,
            close, or click back button on this page. Your data might be lost.
          </span>
        </div>
      )}
    </div>
