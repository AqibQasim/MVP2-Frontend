  ...
  return (
    <div className="pt relative flex h-[60%] w-[100%] flex-col items-center justify-around font-lufga">
      ...
      <button
        onClick={onClose}
<<<<<<< HEAD
        className="absolute right-2 top-1 text-5xl text-gray-500 hover:text-gray-700"
=======
        className="absolute right-2 top-2 text-5xl text-gray-500 hover:text-gray-700"
