...
import { calculateTimeZoneOffset } from "@/utils/cityTimezoneOffset";
...
function TalentIdPage({ clientCity, client_id, customer_id }) {
  ...
  const talentDetails = [
    ...
    },
    {
      ...
      name: "Time zone",
      content: calculateTimeZoneOffset(clientCity, talent?.customer?.city),
