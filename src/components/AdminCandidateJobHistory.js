...
function AdminCandidateJobHistory({ job_history, total_job_history }) {
  ...
  return (
    ...
    >
      <Table
        columns={
            "grid-cols-[1fr_0.8fr_8rem_6rem_5rem_7.1rem_8.1rem]"
      ...
      >
        <Table.Header>
          ...
          <div className="experience text-center">Skills</div>
          <div className="commit text-center">Experience</div>
          <div className="status text-center">Job Type</div>
