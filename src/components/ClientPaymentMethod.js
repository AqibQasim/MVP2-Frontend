    ...
    <DashboardSection paragraph="Below is your" heading="Payment method">
      <div className="payment-method-wrapper grid !w-full grid-cols-[repeat(auto-fill,minmax(420px,1fr))] justify-items-start gap-x-1.5 gap-y-2">
        ...
        <div
          ...
          className="button flex w-full cursor-pointer items-center justify-start gap-8 rounded-xl border border-dashed border-primary-tint-80 p-4"
        >
          {/* Entity */}
      ...
      <Modal isOpen={isModalOpen} onClose={handleCloseModal}>
        <div className="body-scroll max-h-[95vh] w-full gap-4 overflow-y-auto rounded-[24px] bg-neutral-white p-6">
          <form onSubmit={handleSubmit}>
            <label>
              ...
              <input
                ...
                className="ms-2 rounded-md border-2 p-2"
            ...
            <button
              type="submit"
              className="mt-3 rounded-xl bg-primary p-3 text-white"
            >
              Save Payment Method
            </button>
          </form>
